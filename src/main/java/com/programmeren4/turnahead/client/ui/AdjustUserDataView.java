...
public class AdjustUserDataView extends Composite {
	...
	interface RegistrationViewUiBinder extends
			UiBinder<Widget, AdjustUserDataView> {
	}

	public AdjustUserDataView() {
	...
	@UiHandler("terug")
	void OnclickButtonTerug(ClickEvent e){
		// go back Historymanagement
	}
}
